...
def nft():
    ...
    progress = 'The process was not executed'
    ...
    try:
        ...
        progress = 'Test tokens of the project have been minted'
        ...
        progress = 'Test tokens & LP tokens of the project have been minted'
        ...
        progress = 'Test tokens & LP tokens of the project have been minted + The tokens were staked'
        ...
        progress = 'Test tokens & LP tokens of the project have been minted + The tokens were staked + The LP tokens were staked'
        ...
        progress = 'Dolven Labs tasks have been completed'
    except:

        driver.switch_to.window(driver.window_handles[0])
        progress = 'Dolven Labs tasks are not fully completed'
    ...
    try:
        ...
        progress = 'The form has been sent'
    ...
    try:
        ...
        progress = 'Dolven Labs + Swaps have been carried out'
    ...
    try:
        ...
        progress += ' + An offer has been made on Mintsquare'
    ...
    try:
        ...
        progress += ' + An offer has been made on Aspect'
    except:
        pass
    ...
    while True:
        try:
            ...
            try:
                ...
                print('Problems with the audience')
