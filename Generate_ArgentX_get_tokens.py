...
def nft():
    ...
    while FF == True:
        ...
        time.sleep(1)
        wait.until(element_to_be_clickable((By.CSS_SELECTOR, 'button[class*="Button-module_button"]')))
        ActionChains(driver).move_to_element(driver.find_elements(By.CSS_SELECTOR, 'button[class*="Button-module_button"]')[-1]).click().perform()
